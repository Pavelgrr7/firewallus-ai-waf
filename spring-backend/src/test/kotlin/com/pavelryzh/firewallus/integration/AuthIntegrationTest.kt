...
class AuthIntegrationTest {
    ...
    @Test
    fun `POST login with WRONG password should return 401 or 400 Bad Request`() {
        val realAdmin = Admin(
    ...
    fun PasswordEncoder.encodeSafe(rawPassword: String): String {
        return passwordEncoder.encode(rawPassword) ?: throw RuntimeException("passwordEncoder were unable to encode password: $rawPassword")
    }
}
